...
export default function App () {
  return(
    ...
    <div className='flex justify-start gap-4'>
      <a target='_blank' href='https://github.com/WellDN' title='Github' className="hover:text-blue-900">
    ...
    <a target='_blank' href='mailto:wellingtontp0@gmail.com' title='Email' className="transition-colors hover:text-blue-900">
    <svg className="w-10" viewBox='0 0 24 24'>
